...
class EvidenceBundle(BaseModel):
    ...
    bundle_version: str = Field(..., pattern='^\\d+\\.\\d+\\.\\d+$')
    bundle_id: str = Field(..., pattern='^bun_[0-9A-HJKMNP-TV-Z]{26}$')
    generated_at: AwareDatetime
    tenant_id: str = Field(..., pattern='^tnt_[0-9a-z]{12}$')
    engagement_id: str | None = Field(None, pattern='^eng_[0-9A-HJKMNP-TV-Z]{26}$')
    period: Period
    events: list[Event]
    manifests: list[Manifest]
    schema_versions_used: list[BundleVersion]
